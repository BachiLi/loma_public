...
\begin{itemize}
    ...
    \item \textbf{Slang}: we use \href{https://shader-slang.org/}{Slang} and its Python binding \href{https://slangpy.shader-slang.org/}{SlangPy} for generating parallel GPU code. 
\end{itemize}
