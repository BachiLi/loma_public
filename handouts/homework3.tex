...
We will test on the Slang backend. We have three tests for the parallel automatic differentiation: \lstinline{test_parallel_copy}, \lstinline{test_parallel_add}, and \lstinline{test_parallel_reduce}.
